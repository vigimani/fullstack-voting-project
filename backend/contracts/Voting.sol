...
/// @title My first voting contract - project 3
/// @author Victor
/// @notice You can use this contract to simulate a voting process
/// @dev All function calls are currently implemented without side effects - a patch has been added to prevent DDos attack
contract Voting is Ownable {
    ...
    function addProposal(string calldata _desc) external onlyVoters {
        ...
        //added to prevent DDos attack and tested in vote-add.test line87
        require(proposalsArray.length<100, 'Maximum of proposals reached');
